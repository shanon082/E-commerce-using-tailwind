...
<head>
    ...
    <title>Edit Product - TUKOLE Business</title>
            ...
            <div class="bg-white rounded-lg shadow-sm overflow-hidden">
                <div class="p-6 border-b border-gray-200">
                    <div class="flex items-center">
                        ...
                        >
                        <div>
                            <h2 class="text-lg font-medium"><?php echo htmlspecialchars($product['name']); ?></h2>
                            <p class="text-gray-500">ID: <?php echo $product['id']; ?></p>
                            <p class="text-gray-500">Created: <?php echo date('M d, Y', strtotime($product['created_at'])); ?></p>
                        </div>
                    </div>
                </div>
                
                <form action="edit_product.php?id=<?php echo $product_id; ?>" method="post" class="p-6">
